...
from src.ava.prompts import REVIEWER_PROMPT, CODE_SNIPPET_GENERATOR_PROMPT
...
class GenerationCoordinator:
    ...
    async def _execute_task(self, task: Dict[str, Any], current_files: Dict[str, str]) -> Dict[str, str]:
        ...
        # Announce that we are about to process this file for real-time visualization
        self.event_bus.emit("file_generation_starting", filename)
        await asyncio.sleep(0.1) # A small delay to allow the UI to react
        # --- END OF CORRECTION ---
